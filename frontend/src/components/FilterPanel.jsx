export default function FilterPanel({ filters, setFilters, meta }) {
  ...
  return (
    <section>
      <h2 className="kicker border-b border-ink pb-2 mb-4">Refine</h2>
      ...
      <div className="flex flex-col gap-6">
        ...
        <label className="block">
          ...
          <select
            ...
            className="mt-2 w-full bg-paper-2 border border-rule px-3 py-2 font-sans text-sm text-ink focus:outline-none focus:border-accent"
          >
        ...
        <div>
          ...
          <div className="mt-2 grid grid-cols-2 gap-px bg-rule border border-rule">
            {[
